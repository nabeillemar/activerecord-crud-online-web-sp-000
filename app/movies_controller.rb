...
def can_be_instantiated_and_then_saved
  movie = Movie.new #creating a new one
  movie.title = "This is a title." #naming the new title
  movie.save #saving it 
end
...
def can_be_created_with_a_hash_of_attributes
  ...
  movie = Movie.create(attributes) #using the create method with the attributes given
end
